...
import { clientAtom, deviceAtom, hostAtom, spectatorsAtom, teamsAtom } from "./GlobalState";
...
export default function SettingsHtml(props) {
  ...
  return <group {...props}>
    { client.socketId === host.socketId && <SettingsHost/> }
    { client.socketId !== host.socketId && <SettingsGuest/> }
  </group>
}
